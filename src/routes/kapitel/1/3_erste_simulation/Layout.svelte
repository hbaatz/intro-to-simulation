        ...
        <div class="simControls">
            <div style="display: flex;">
                <div class="buttonGroup">
                    <Simulation {stepFunc} {initialState} {constants} bind:currentState bind:currentTime active={!errorMsg}/>
                </div>
                {#if readout}
                    <div class="spacer"></div> 
                    <div class="buttonGroup">
...
<div class="sceneView">
    <Canvas>
        <Scene points={currentState} directions={constants} {showArrows} {showTicks} {target} {cameraFocus} {cameraZoom}/>
    </Canvas>
</div>
